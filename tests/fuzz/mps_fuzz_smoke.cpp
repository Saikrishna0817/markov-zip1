...
int main() {
    ...
    sihopt::io::MpsLimits limits; limits.maximum_bytes = 1024; limits.maximum_lines = 256; limits.maximum_rows = 128; limits.maximum_columns = 128; limits.maximum_nonzeros = 1024; limits.maximum_name_bytes = 64;
    for (int trial = 0; trial < 5000; ++trial) {
        ...
        try { (void)sihopt::io::parse_mps_string(input, limits); } catch (const std::exception&) {}
    }

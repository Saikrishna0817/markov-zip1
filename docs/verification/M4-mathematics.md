...
Cold/warm equivalence, strict and Harris ratio modes, tableau-norm and Bland pricing, feasible and infeasible RHS changes, stale/duplicate basis rejection, serialization corruption, iteration limits, randomized objective parity, and Farkas witnesses are tested.

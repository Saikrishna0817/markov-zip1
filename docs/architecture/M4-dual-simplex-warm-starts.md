...
The public contract includes a matrix/objective fingerprint, strict basis serialization with checksum, Bland or exact dense steepest-edge leaving-row pricing, conservative two-pass Harris ratio selection, iteration telemetry, refactorization counts, and explicit cold-fallback disclosure.

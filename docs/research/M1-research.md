...
IBM and MOSEK MPS references define section roles, row types, bounds, ranges, integer markers, defaults, duplicate-entry behavior, and dialect differences. SIHOpt deliberately supports a documented strict free-format subset and rejects ambiguity instead of guessing.
